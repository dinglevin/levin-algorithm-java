...
public class Number001Test {
    @Test
    public void testTwoSumV0() {
        assertArrayEquals(new int[] { 0, 1 }, Number001.twoSumV0(new int[] { 2, 7, 11, 15 }, 9));
        assertArrayEquals(new int[] { 1, 2 }, Number001.twoSumV0(new int[] { 3, 2, 4 }, 6));
        assertArrayEquals(new int[] { 0, 1 }, Number001.twoSumV0(new int[] { 3, 3 }, 6));
    }
