...
public class Number002Test {
    ...
    public void testAddTwoNumbersV1() {
        ListNode result = new Number002.Version1().invoke(create(new int[] { 2, 4, 3 }),
                create(new int[] { 5, 6, 4 }));
        assertEquals(Lists.newArrayList(7, 0, 8), convertToList(result));

        result = new Number002.Version1().invoke(create(new int[] { 0 }), create(new int[] { 0 }));
        assertEquals(Lists.newArrayList(0), convertToList(result));

        result = new Number002.Version1().invoke(create(new int[] { 9, 9, 9, 9, 9, 9, 9 }),
    ...
    public void testAddTwoNumbersV2() {
        ListNode result = new Number002.Version2().invoke(create(new int[] { 2, 4, 3 }),
                create(new int[] { 5, 6, 4 }));
        assertEquals(Lists.newArrayList(7, 0, 8), convertToList(result));

        result = new Number002.Version2().invoke(create(new int[] { 0 }), create(new int[] { 0 }));
        assertEquals(Lists.newArrayList(0), convertToList(result));

        result = new Number002.Version2().invoke(create(new int[] { 9, 9, 9, 9, 9, 9, 9 }),
                create(new int[] { 9, 9, 9, 9 }));
        assertEquals(Lists.newArrayList(8, 9, 9, 9, 0, 0, 0, 1), convertToList(result));
    }
